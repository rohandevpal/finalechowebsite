...
module.exports = {
  siteMetadata: {
    ...
    title: "ECHO India",
    description:
      "ECHO India is a non-profit trust working towards building capacities across areas such as Healthcare, Education and other Sustainable Development Goals.",
  },
  plugins: [
